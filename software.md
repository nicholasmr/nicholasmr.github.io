...
- **Spectral orientation fabric model** ***specfab*** ([GitHub](https://github.com/nicholasmr/specfab))
...
- **Radio-wave transfer matrix model** ([GitHub](https://github.com/nicholasmr/tamm))
...
- **Polarimetric traveltime tomography model** ([GitHub](https://github.com/nicholasmr/ptt))
...
- **Large-area scanning microscope software** ([GitHub](https://github.com/nicholasmr/LASM))
